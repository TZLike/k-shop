package com.huatech.shop.base.freemarker;
...
/**
 * Freemarker tag that renders the tag body if the current user known to the dict, either from a successful login attempt
