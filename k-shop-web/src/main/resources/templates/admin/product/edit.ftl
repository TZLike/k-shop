        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="frm" method="post" action="${ctx!}/seller/product/edit">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-7">
                                    <input id="productName" name="productName" class="form-control" type="text"
                                           placeholder="请输入商品名称" value="${product.productName}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-7">
                                    <input id="productSummary" name="productSummary" class="form-control" type="text"
                                           placeholder="请输入商品简介" value="${product.productSummary}">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-7">
                                    <input value="${product.productStock}" placeholder="请输入商品库存" id="productStock" name="productStock"
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-7">
                                    <input id="productOriginalPrice" name="productOriginalPrice" class="form-control"
                                           type="text"
                                            value="${product.productOriginalPrice}"    placeholder="请输入商品原价" onkeyup="value=value.replace(/[^\d]/g,'')">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-7">
                                    <input id="productNowPrice" name="productNowPrice" class="form-control"
                                           type="text"
                                           value="${product.productNowPrice}"     placeholder="请输入商品现价" onkeyup="value=value.replace(/[^\d]/g,'');">
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <#list productStatus as dictInfo>
                                        <option value="${dictInfo.dictCode}" <#if dictInfo.dictCode == product.productStatus>selected="selected"</#if>>${dictInfo.info}</option>
                                    </#list>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <#list productSales as dictInfo>
                                        <option value="${dictInfo.dictCode}"  <#if dictInfo.dictCode == product.productSalesType>selected="selected"</#if>>${dictInfo.info}</option>
                                    </#list>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <#list productIfRecommends as dictInfo>
                                        <option value="${dictInfo.dictCode}" <#if dictInfo.dictCode == product.productIfRecommend>selected="selected"</#if>>${dictInfo.info}</option>
                                    </#list>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <#list productIfCanInvoices as dictInfo>
                                        <option value="${dictInfo.dictCode}" <#if dictInfo.dictCode == product.productIfCanInvoice>selected="selected"</#if>>${dictInfo.info}</option>
                                    </#list>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-6">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <#list productGoodsTypes as dictInfo>
                                        <option value="${dictInfo.dictCode}" <#if dictInfo.dictCode == product.productGoodsType>selected="selected"</#if>>${dictInfo.info}</option>
                                    </#list>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input id="productDescription" name="productDescription"
                                       class="laydate-icon form-control layer-date" placeholder="请输入商品介绍" value="${product.productDescription}"
                                >
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="fileinput fileinput-new" data-provides="fileinput" id="uploadImageDiv">
                                    <div class="fileinput-new thumbnail" style="width: 120px; height: 90px;">
                                        <img id="img" src="${product.productImage}" alt=""/>
                                    </div>
