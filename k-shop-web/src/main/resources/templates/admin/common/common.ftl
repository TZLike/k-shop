...
<!-- 日期 -->
<script type="text/javascript" src="${ctx!}/datetimepicker/js/bootstrap-datepicker.min.js"></script>
<!-- 时间 -->
<script type="text/javascript" src="${ctx!}/datetimepicker/js/bootstrap-timepicker.min.js"></script>
<!-- 日期+时间 -->
<script type="text/javascript" src="${ctx!}/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
